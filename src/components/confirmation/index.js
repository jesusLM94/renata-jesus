...
const Confirmation = () => {
  ...
  return (
    <section
      className="flex justify-center flex-col items-center mt-10 sm:mt-16 pb-10 mx-10"
      id="confirmation"
    >
      <h3 className="flex heading-text font-bold justify-center mb-5">
        Medidas de seguridad Covid-19
      </h3>
      <p className="text-justify mt-5 sm:mt-10">
      ...
      {hasInvitation ? (
        <Fragment>
          ...
          <p className="mt-5 sm:mt-10 text-center ">Llena nuestro formulario y sé parte de nuestro gran día.</p>
          <p className="my-5"> Dale click al siguiente botón.</p>
          <PopupButton
            id="h1Xufz1d"
            style={{ fontSize: 20 }}
            className="bg-secondary hover:bg-hover text-white font-bold py-2 px-4 rounded-full mt-5"
          >
            RSVP
          </PopupButton>
        </Fragment>
